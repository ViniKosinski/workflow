...
const hashPassword = (password) => hash(password, { algorithm: 2, memoryCost: 19_456, timeCost: 2, parallelism: 1, outputLen: 32 });
const now = new Date();
const users = [
  { id: "purchase-owner", email: "gestor@compras.test", name: "Gestora de Compras", role: "OWNER", password: "CompraTeste123!" },
  { id: "purchase-requester", email: "solicitante@compras.test", name: "Solicitante", role: "EDITOR", password: "CompraTeste123!" },
  { id: "purchase-approver", email: "aprovador@compras.test", name: "Aprovador", role: "ADMIN", password: "CompraTeste123!" },
  { id: "purchase-admin", email: "admin@compras.test", name: "Admin", role: "ADMIN", password: "admin 123" },
];
...
console.log("Piloto criado. Senha padrão: CompraTeste123!; admin@compras.test: admin 123");
